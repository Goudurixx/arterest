package com.goudurixx.arterest
...
import com.goudurixx.arterest.ui.theme.ArterestTheme
import com.goudurixx.arterest.xr.SpatialContent
...
fun My2DContent(onRequestFullSpaceMode: () -> Unit) {
    Surface {
        Row(
            ...
            if (true) {
//       TODO FIX     if (LocalSpatialCapabilities.current.isSpatialUiEnabled) {
