package com.goudurixx.arterest.xr
...
import com.goudurixx.arterest.shared.component.ArterestPost
import com.goudurixx.arterest.shared.component.SearchBar
import com.goudurixx.arterest.shared.viewModel.MainViewModel
        ...
        SpatialColumn(
            ...
            SpatialPanel(
                ...
                Surface(
                    ...
                    val previousTerm = viewModel.searchTerm.collectAsState().value
                    val term = previousTerm.ifEmpty {
                        ""
                    }

                    SearchBar(term) {
                        viewModel.search(it, maxPostCount)
                    }
                }
            }
